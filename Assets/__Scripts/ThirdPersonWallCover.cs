...
public class ThirdPersonWallCover : MonoBehaviour {
	...
	[Header("Audio Snapshot")]
	public AudioMixerSnapshot coverSnapshot;
	public AudioMixerSnapshot noCoverSnapshot;
 ...
 //       }
    ...
    void EnterCover(int pDir) {
		...
		coverSnapshot.TransitionTo (0.1f);
    }
    ...
    void ExitCover() {
		...
		noCoverSnapshot.TransitionTo (0.1f);
    }
